...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> approve(int userId, int bookingId, Boolean isApproved) {
        Map<String, Object> parameters = Map.of(
                "approved", isApproved
        );
    ...
    public ResponseEntity<Object> getByOwnerId(int userId, BookingStatus state, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
