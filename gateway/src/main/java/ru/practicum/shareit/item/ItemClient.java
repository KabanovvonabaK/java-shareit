...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> create(int userId, ItemShortDto itemShortDto) {
        return post("", userId, itemShortDto);
    }

    public ResponseEntity<Object> getByItemId(int userId, int itemId) {
        return get("/" + itemId, userId);
    }

    public ResponseEntity<Object> getByOwnerId(int userId, int from, int size) {
...
//    }
    ...
    public ResponseEntity<Object> addComment(int userId, int itemId, CommentRequestDto commentRequestDto) {
